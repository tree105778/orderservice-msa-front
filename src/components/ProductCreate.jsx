...
import { API_BASE_URL, PROD } from '../configs/host-config.js';
import { handleAxiosError } from '../configs/HandleAxiosError.js';
...
const ProductCreate = () => {
  ...
  const fileUpdate = () => {
    ...
    reader.onloadend = () => {
      setThumbnailImage(reader.result); // 썸네일은 FileReader의 처리
    };
  };
